...
Cursor’s free plan (50 requests/Month) was enough to hook me. When I came back to coding after a short break I started paying for Pro, and for the first few months I was experimenting non-stop, adding documentation, libraries and resources to cursor, letting agents apply fixes to files, creating files without me telling them line by line. At times it felt like Cursor was doing the boring, repetitive work I hate, leaving me to the parts of engineering I actually enjoy.  
...
This is where things went sideways for me. For months the $20 Pro plan and the way usage was shown in the dashboard made sense, you had a simple “credits” view and you could see how many you’ve used. It was predictable, and it let me recommend the product confidently.  
